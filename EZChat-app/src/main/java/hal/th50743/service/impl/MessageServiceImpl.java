    ...
    public void saveMessage(Integer userId, Integer chatId, String text, List<Image> images) {
        ...
        if (images != null && !images.isEmpty()) {
            ...
            try {
                ...
                throw new RuntimeException("Failed to serialize object names list: " + e.getMessage());
            }
        }
        // 创建消息对象
    ...
    public Map<String, Object> getMessagesByChatCode(Integer userId, String chatCode, String timeStamp) {
        ...
        if (timeStamp != null && !timeStamp.isEmpty()) {
            try {
                ...
                // TODO: 以后使用全局异常处理器抛出 InvalidTimeStampException
                throw new RuntimeException("Invalid request: Incorrect timestamp format");
            }
        }
