...
<style scoped>
.user-item-wrapper { display: flex; align-items: center; padding: 10px 16px; border-radius: var(--radius-base); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); user-select: none; background: transparent; }
