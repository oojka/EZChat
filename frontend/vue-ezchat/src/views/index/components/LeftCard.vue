...
.guest-badge { display: inline-block; font-size: 11px; font-weight: 800; color: var(--primary); background: rgba(64, 158, 255, 0.12); padding: 6px 12px; border-radius: var(--radius-round); margin-bottom: 16px; letter-spacing: 1.5px; transition: all 0.3s ease; }
...
.feature-item .el-icon { font-size: 20px; color: var(--primary); background: var(--bg-card); padding: 8px; border-radius: var(--radius-round); border: 1px solid var(--el-border-color-light); }
.guest-footer { display: flex; justify-content: flex-end; }
.guest-arrow { display: flex; align-items: center; gap: 8px; color: #fff; background: var(--primary); padding: 12px 24px; border-radius: var(--radius-md); font-weight: 700; font-size: 15px; box-shadow: 0 8px 16px rgba(64, 158, 255, 0.3); transition: all 0.3s ease; cursor: pointer; }
...
.modern-tabs-small { width: 100%; display: flex; background: var(--bg-page); padding: 4px; border-radius: var(--radius-base); border: 1px solid var(--el-border-color-extra-light); }
:deep(.modern-tabs-small .el-radio-button) { flex: 1; }
:deep(.modern-tabs-small .el-radio-button__inner) { width: 100%; background: transparent; border: none; border-radius: var(--radius-sm); padding: 8px 0; font-weight: 700; box-shadow: none !important; color: var(--text-500); transition: all 0.3s; }
...
.url-textarea :deep(.el-textarea__inner) { padding: 10px 16px; line-height: 1.4; background-color: var(--bg-page); color: var(--text-900); border: 1px solid var(--el-border-color-light); border-radius: var(--radius-base); transition: all 0.3s; }
...
.join-submit-btn { width: 100%; height: 46px; border-radius: var(--radius-md); font-weight: 800; font-size: 16px; margin: 0 !important; }
.join-cancel-btn { width: 100%; height: 46px; border-radius: var(--radius-md); font-weight: 700; font-size: 15px; background: var(--bg-page); border: none; color: var(--text-500); margin: 0 !important; transition: all 0.3s; }
