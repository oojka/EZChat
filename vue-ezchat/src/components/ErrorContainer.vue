    ...
    <div class="layout-container">
      ...
      <div class="right-panel">
        <div class="card-lang-tool">
          <el-dropdown trigger="click" @command="(l) => emit('change-lang', l)" placement="bottom-end">
...
.code-badge {
  display: flex; align-items: center; gap: 8px; padding: 8px 20px; border-radius: 100px; margin-bottom: 24px;
...
.accent-bar { width: 80px; height: 8px; border-radius: 4px; margin-top: 32px; }
...
.title-underline {
  width: 40px; height: 4px; background: #e2e8f0; border-radius: 2px; margin-top: 16px;
}
...
.mini-lang-btn {
  ...
  background: rgba(241, 245, 249, 0.8); border-radius: 10px; color: #64748b; cursor: pointer; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
}
...
.glass-btn {
  background: rgba(255, 255, 255, 0.8) !important; border: 1px solid #e2e8f0 !important; border-radius: 18px;
...
.primary-btn {
  border-radius: 18px; font-weight: 800; letter-spacing: 0.5px; min-width: 140px; height: 52px;
