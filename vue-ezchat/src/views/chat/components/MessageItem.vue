...
.user-avatar { flex-shrink: 0; border-radius: 10px; border: 1px solid var(--el-border-color-light); transition: all 0.3s ease; }
...
/* --- 文字气泡基础样式 --- */
.message-text-bubble {
  padding: 8px 14px; border-radius: 14px; font-size: 16px; line-height: 1.6; word-break: break-word;
...
.img-item {
  max-width: 300px; width: 100%; aspect-ratio: 1 / 1; border-radius: 10px; cursor: pointer; display: block;
